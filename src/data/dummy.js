...
export const EditorData = () => (
  <div>
    <h3>
      📄 Software Requirements Specification (SRS) - Admin-Panel Project <br />
      <br />
      The purpose of this document is to define the requirements for developing a React Admin Dashboard App. This app will provide administrators with a powerful and customizable interface for data visualization, task management, and business analysis.
      <br />
      The application will be a responsive, modular dashboard built using React.js.<br /> It will include features such as:
      <br />
      1. Customizable themes<br />

      2. Interactive tables and charts<br />

      3. Integrated calendar<br />

      4. Kanban board for task management<br />
      <br />
      ...
      -End Users (Admins/Employees)<br />
      <br />
      Definitions:<br />
      i. CRUD: Create, Read, Update, Delete<br />

      ii. Kanban: A visual task management board<br />

      iii. Recharts/FullCalendar: Libraries used for charts and calendar views respectively<br />

      <br />
      This system is a standalone web-based admin dashboard.<br /> It is intended to be part of a larger enterprise application or used as a template.
      <br /><br />Product Functions<br />
      1. Toggle between dark/light mode and select custom color themes
      <br />
      2. View and edit data using tables with search and filters
      <br />
      3. Analyze metrics using line/bar/pie/area charts
      <br />
      4. Schedule events and meetings in a full-featured calendar
      <br />
      5. Manage tasks with a Kanban board (drag-and-drop functionality)
      <br />
...
export const chatData = [
  {
    image:
      avatar2,
    message: 'Vaishnavi Joined the Team!',
  ...
  },
  {
    ...
    desc: 'Ketan sent you new message',
    time: '11:56 AM',
  },
  {
    image:
  ...
  },
  {
    image:
      avatar,
    message: 'Ajinkya completed tasks',
